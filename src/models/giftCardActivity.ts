...
import {
  ...
  GiftCardActivateActivityDetails,
  giftCardAdjustDecrementActivityDetails,
  giftCardAdjustIncrementActivityDetails,
  GiftCardAdjustIncrementActivityDetails,
  giftCardBlockActivityDetails,
  GiftCardBlockActivityDetails,
  giftCardClearBalanceActivityDetails,
  GiftCardClearBalanceActivityDetails,
  giftCardDeactivateActivityDetails,
  GiftCardDeactivateActivityDetails,
  giftCardImportActivityDetails,
  GiftCardImportActivityDetails,
  giftCardLoadActivityDetails,
  GiftCardLoadActivityDetails,
  giftCardOtherActivityDetails,
  GiftCardOtherActivityDetails,
  giftCardRedeemActivityDetails,
  GiftCardRedeemActivityDetails,
  giftCardRefundActivityDetails,
  GiftCardRefundActivityDetails,
  giftCardUnblockActivityDetails,
  GiftCardUnblockActivityDetails,
...
export const giftCardActivitySchema: Schema<GiftCardActivity> = object({
  ...
  activateActivityDetails: [
    ...
    optional(lazy(() => giftCardActivateActivityDetails)),
  ],
  loadActivityDetails: [
    'load_activity_details',
    optional(lazy(() => giftCardLoadActivityDetails)),
  ],
  clearBalanceActivityDetails: [
    'clear_balance_activity_details',
    optional(lazy(() => giftCardClearBalanceActivityDetails)),
  ],
  deactivateActivityDetails: [
    'deactivate_activity_details',
    optional(lazy(() => giftCardDeactivateActivityDetails)),
  ],
  redeemActivityDetails: [
    'redeem_activity_details',
    optional(lazy(() => giftCardRedeemActivityDetails)),
  ],
  refundActivityDetails: [
    'refund_activity_details',
    optional(lazy(() => giftCardRefundActivityDetails)),
  ],
  unlinkedActivityDetails: [
    'unlinked_activity_details',
    optional(lazy(() => giftCardUnlinkedActivityDetails)),
  ],
  adjustIncrementActivityDetails: [
    'adjust_increment_activity_details',
    optional(lazy(() => giftCardAdjustIncrementActivityDetails)),
  ],
  adjustDecrementActivityDetails: [
    'adjust_decrement_activity_details',
    optional(lazy(() => giftCardAdjustDecrementActivityDetails)),
  ],
  blockActivityDetails: [
    'block_activity_details',
    optional(lazy(() => giftCardBlockActivityDetails)),
  ],
  unblockActivityDetails: [
    'unblock_activity_details',
    optional(lazy(() => giftCardUnblockActivityDetails)),
  ],
  importActivityDetails: [
    'import_activity_details',
    optional(lazy(() => giftCardImportActivityDetails)),
  ],
  otherActivityDetails: [
    'other_activity_details',
    optional(lazy(() => giftCardOtherActivityDetails)),
  ],
