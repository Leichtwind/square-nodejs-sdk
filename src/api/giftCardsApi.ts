...
import {
  GiftCardActivityRequest,
  giftCardActivityRequestSchema,
} from '../models/giftCardActivityRequest';
import {
  GiftCardActivityResponse,
  giftCardActivityResponseSchema,
} from '../models/giftCardActivityResponse';
import { ListGiftCardActivityRequest } from '../models/listGiftCardActivityRequest';
import {
  ListGiftCardActivityResponse,
  listGiftCardActivityResponseSchema,
} from '../models/listGiftCardActivityResponse';
import {
...
export class GiftCardsApi extends BaseApi {
  ...
  listGiftCardActivities(
    body: ListGiftCardActivityRequest,
    requestOptions?: RequestOptions
  ): Promise<ApiResponse<ListGiftCardActivityResponse>> {
